  ...
  return (
    <div className="max-w-3xl rounded-lg bg-white p-6 shadow-sm">
      ...
      <form onSubmit={handleSave} className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <label className="text-sm font-medium text-slate-700">
          Адреса відправника
          <input className="mt-1 w-full rounded-lg border border-slate-300 px-3 py-2" type="email" value={form.from} onChange={(e) => update("from", e.target.value)} placeholder="platform@company.com" required />
        </label>
